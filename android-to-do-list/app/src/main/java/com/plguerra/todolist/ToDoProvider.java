...
public class ToDoProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.plguerra.todolist.todoprovider";
    ...
    public static final String TODO_TABLE_COL_DEADLINE = "DEADLINE";
    public static final String TODO_TABLE_COL_REMINDER = "REMINDER";
    ...
    private static final String SQL_CREATE_MAIN = "CREATE TABLE " +
            ...
            TODO_TABLE_COL_DEADLINE + " TEXT, " +
            TODO_TABLE_COL_REMINDER + " TEXT)";
